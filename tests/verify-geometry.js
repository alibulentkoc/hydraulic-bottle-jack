...
function check(tag){
  for(const th of [0, 0.5, 1]){
    ...
    for(const r of [0, 0.5, 1]){
      ...
      rec("riser separation",         g.xResR - g.xResRel, tag);
...
Object.assign(dims, DEFAULTS, { ramDia:110, boreDia:120, pivotLink:80, pumpDia:26,
  pumpStroke:45, handleLen:700, ramStrokeMax:200, pumpCylLen:110 }); check("all maximum");
Object.assign(dims, DEFAULTS, { ramDia:20, boreDia:22, pivotLink:15, pumpDia:4,
  pumpStroke:5, handleLen:150, ramStrokeMax:20, pumpCylLen:30 }); check("all minimum");
